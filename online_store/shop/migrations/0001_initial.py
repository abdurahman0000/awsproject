    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('onwer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.userprofile')),
            ],
        ),
        migrations.CreateModel(
            name='ProductPhotos',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('perent_review', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='replies', to='shop.review')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='resviews', to='shop.product')),
